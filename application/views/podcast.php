...
<div class="event-select oprec form-lomba" style="height:100%;" id="oprec-input">
    <div id="form-lomba" style="transform:scale(0.7)">
        ...
        <form action="<?= base_url('Lomba/registration_podcast2'); ?>" method="POST" class="commpress-form form-center" id="form-2" style="display:none;">
        ...
        <form action="<?= base_url('Lomba/registration_podcast3'); ?>" method="POST" class="commpress-form form-center" id="form-3" style="display:none;">
