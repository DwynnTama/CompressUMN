  ...
  <section class="vertical-scrolling">
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                ...
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/Foto 1.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/Foto 4.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/Foto 5.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/Foto 6.jpg")?>"/>
                </div>
            </div>
        </div>
  </section>
