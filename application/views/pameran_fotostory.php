...
<div id="fullpage">
    <section class="vertical-scrolling">
        ...
        aman, dan berlimpah fasilitas dibandingkan pemukiman nonklaster.</p>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame"> 
                <span style="display:block"></span>
                <div class="inframe" style="position:absolute">
                <p>Rumah yang mampu memberikan kenyamanan bagi penghuninya tentu tidak dibangun dengan 
        ...
        dalam kondisi yang kontras dengan apa yang mereka bangun.</p>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame"> 
                <span style="display:block"></span>
                <div class="inframe" style="position:absolute">
                    <p> Kerap kali, profesi tenaga kerja konstruksi dipandang sebelah mata oleh khalayak luas. Mereka 
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                ...
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/1_1.jpg")?>"/>
                    <h4>Rumah-rumah di Cluster Maxwell, Summarecon Serpong, yang sudah selesai dibangun.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
...
selama proyek berlangsung.</h4>
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/1_3.jpg")?>"/>
                    <h4>Sol sepatu yang lepas di area proyek.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/1_4.jpg")?>"/>
                    <h4>Dua orang pekerja konstruksi bercengkrama di depan rumah bedeng.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/1_5.jpg")?>"/>
                    <h4>Jemuran bergantung di rumah bedeng.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/1_6.jpg")?>"/>
                    <h4>Tampak luar rumah bedeng tempat para pekerja konstruksi tinggal.</h4>
                </div>
            </div>
        </div>
    </section>
...
daring, dan lainnya bisa saya lakukan di ruang 4x2.5 meter ini.</p>
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block;"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/2_1.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/2_2.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/2_3.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/2_4.jpg")?>"/>
                </div>
            </div>
        </div>
    </section>
...
untuk bertahan hidup</p>
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block;"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/4_1.jpg")?>"/>
                    <h4>Alat berat yang digunakan untuk mengurai lautan sampah di TPST Bantar Gebang.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/4_2.jpg")?>"/>
                    <h4>Ibu Eni yang sedang menikmati makanannya meskipun berada disekitar hamparan sampah.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/4_3.jpg")?>"/>
                    <h4>Para pekerja yang sedang memungut sampah yang nantinya akan diurai.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/4_5.jpg")?>"/>
                    <h4>Para pekerja yang sedang berjalan di tengah tumpukan sampah.</h4>
                </div>
            </div>
        </div>
    </section>
...
ditawarkan harus dimanfaatkan sebaik mungkin.</p>
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/5_1.jpg")?>"/>
                    <h4>Seorang ibu-ibu yang mencegah penyebaran virus Covid-19 dengan menggunakan kantong plastik sebagai tempat penyimpanan uang tunai.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/5_2.jpg")?>"/>
                    <h4>Pengumuman yang dikeluarkan oleh pihak pengelola mengenai aktivitas pasar di tengah pandemi.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/5_3.jpg")?>"/>
                    <h4>Pelanggaran protokol kesehatan yang dilakukan oleh penjual ketika berinteraksi dengan pembeli saat memilih jeruk Kasturi.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/5_4.jpg")?>"/>
                    <h4>Kios makanan yang masih buka walau sepi pengunjung.</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/5_5.jpg")?>"/>
                    <h4>Pengunjung yang memilih jeruk menggunakan sarung tangan sebagai salah satu upaya pencegahan Covid-19</h4>
                </div>
            </div>
        </div>
    </section>
...
menghabiskan waktunya di Pasar Beringharjo dengan penuh sukacita dan keramahannya.</p>
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block;"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/7_1.jpg")?>"/>
                    <h4>Trisno Wiyadi berbincang-bincang dengan pelanggannya</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/7_2.jpg")?>"/>
                    <h4>Trisno Wiyadi satu-satunya penyedia jasa perbaikan kacamata di sekitar Pasar Beringharjo</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
...
milik pelanggannya</h4>
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/7_4.jpg")?>"/>
                    <h4>Tangan dingin Trisno Wiyadi sedang memperbaiki kacamata</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/7_5.jpg")?>"/>
                    <h4>Lapak milik Trisno Wiyadi di sekitar area Pasar Beringhardjo</h4>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/7_6.jpg")?>"/>
                    <h4>Lapak milik Trisno Wiyadi di area Pasar Beringharjo</h4>
                </div>
            </div>
        </div>
    </section>
...
orang terdekat salah satunya adalah dengan memberikan hampers.
        ...
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block;"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/8_1.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/8_2.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/8_3.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/8_4.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/8_5.jpg")?>"/>
                </div>
            </div>
        </div>
        <div class="horizontal-scrolling">
            <div class="frame">
                <span style="display:block"></span>
                <div class="inframe-for-image" style="position:absolute">
                    <img src="<?= base_url("assets/images/fosto/8_6.jpg")?>"/>
                </div>
            </div>
        </div>
    </section>
