        ...
        <form action="<?= base_url('Lomba/registration_podcast3'); ?>" method="POST" class="commpress-form form-center" id="form-1">
            <div style="display:flex;" id="form-main-1">
                ...
                <div class="commpress-card commpress-verticer" style="margin-bottom:10px;width:350px">
                    ...
                    <?= form_error('nama'); ?>
                    <h3>Asal Kampus</h3>
                    <input type="text" name="kampus2" style="width:100%" required /><br />
                    <?= form_error('kampus'); ?>
                    <h3>NIM</h3>
                    <h7>(Khusus Mahasiswa UMN)</h7>
                ...
                <div class="commpress-card commpress-verticer" style="margin-bottom:10px;width:350px">
                    ...
                    <?= form_error('nama'); ?>
                    <h3>Asal Kampus</h3>
                    <input type="text" name="kampus3" style="width:100%" required /><br />
                    <?= form_error('kampus'); ?>
                    <h3>NIM</h3>
                    <h7>(Khusus Mahasiswa UMN)</h7>
            ...
            <div style="display:none;" id="form1-next">
                <div class="commpress-card commpress-verticer" style="width:500px;">
                    <h3>Nama Podcast</h3>
                    <input type="text" name="podcast" style="width:100%" required /><br />
